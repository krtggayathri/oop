...
class Zoo(Snake,GoldFish,Shark,Lion,Deer):
        ...
        def add_animal(self,Animal):
                self.add_animal_list.append(Animal)
...
def hunting(animal,kill):
                ...
                for i in animal.add_animal_list:
                        
                        if i.__class__.__name__=='Deer':
                               
                                count =1
                                animal.add_animal_list.remove(i)
                                #print(animal.add_animal_list)
                        elif i.__class__.__name__=='GoldFish':
                                count1 =1
                                animal.add_animal_list.remove(i)
